...
export interface ApiRequest { action: 'login' | 'dashboard' | 'createSession' | 'closeSession' | 'session' | 'scan' | 'logout'; payload?: Record<string, unknown>; token?: string; }
...
export interface CreateSessionPayload { request_id: string; course: unknown; date: unknown; start_time: unknown; end_time: unknown; late_threshold: unknown; }
